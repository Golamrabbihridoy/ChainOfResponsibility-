	...
	@org.junit.jupiter.api.Test
		   void Test() {
		    	chain chaincalc1=new AddNumbers();
		   		...
		   		assertEquals(2.0,chaincalc2.calculate(new Numbers(4.0,2.0,"sub")));
		   		assertEquals(8.0,chaincalc3.calculate(new Numbers(4.0,2.0,"mult")));
		   		assertEquals(3.0,chaincalc4.calculate(new Numbers(6.0,2.0,"div")));
		       }
